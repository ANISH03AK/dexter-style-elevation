  ...
  return (
    <Layout transparentNav>
      ...
      <section className="relative h-[100vh] min-h-[640px] w-full overflow-hidden bg-ink">
        <img
          src={hero}
          alt="DEXTER model wearing premium black blazer"
          width={1920}
          height={1080}
          className="absolute inset-0 w-full h-full object-cover object-center opacity-90 animate-slow-zoom"
        />
        <div className="absolute inset-0 gradient-hero" />
        <div className="relative h-full container-px mx-auto max-w-[1400px] flex flex-col justify-end pb-24 md:pb-32">
          <div className="max-w-xl text-primary-foreground animate-fade-in-up">
            <p className="text-xs uppercase tracking-[0.4em] text-gold mb-5">FW · 25 Collection</p>
            <h1 className="font-display text-5xl md:text-7xl lg:text-8xl leading-[0.95] font-bold">
              Elevate <br/> Your <em className="not-italic text-gold">Style.</em>
            </h1>
            <p className="mt-6 text-base md:text-lg text-primary-foreground/75 max-w-md">
              Premium menswear, engineered to outlast trends. Discover the new season silhouettes.
            </p>
            <div className="mt-10 flex flex-wrap gap-4">
              <Link
                to="/shop"
                className="group inline-flex items-center gap-3 bg-primary-foreground text-ink px-8 py-4 text-xs uppercase tracking-[0.25em] font-semibold hover:bg-gold hover:text-ink transition-smooth shadow-elevated"
              >
                Shop Now
              ...
              <Link
                to="/shop"
                className="inline-flex items-center gap-3 border border-primary-foreground/40 text-primary-foreground px-8 py-4 text-xs uppercase tracking-[0.25em] font-semibold hover:bg-primary-foreground hover:text-ink transition-smooth"
              >
                Lookbook
              </Link>
            </div>
